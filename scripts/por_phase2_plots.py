...
print("Portuguese EDA started — generating 6 plots...")
print()
...
ax.set_title("Distribution of Final Grades (G3) — Portuguese", fontsize=14, fontweight="bold")
ax.set_xlabel(LABELS["G3"], fontsize=12)
ax.set_ylabel("Number of Students", fontsize=12)
ax.legend()
plt.tight_layout()
plt.savefig("../plots/por_plot1_grade_distribution.png")
plt.show()
print("Plot 1 saved: ../plots/por_plot1_grade_distribution.png")
...
ax.set_title("Pass vs Fail Distribution — Portuguese", fontsize=14, fontweight="bold")
ax.set_xlabel("Outcome", fontsize=12)
ax.set_ylabel("Number of Students", fontsize=12)
ax.set_ylim(0, max(counts.values) * 1.15)
plt.tight_layout()
plt.savefig("../plots/por_plot2_pass_fail.png")
plt.show()
print("Plot 2 saved: ../plots/por_plot2_pass_fail.png")
...
ax.axhline(y=10, color="#C44E52", linestyle="--", linewidth=1.2,
           label="Pass threshold (10)")
ax.set_title(f"{LABELS['studytime']} vs {LABELS['G3']} — Portuguese",
             fontsize=14, fontweight="bold")
ax.set_xlabel(LABELS["studytime"], fontsize=12)
ax.set_ylabel(LABELS["G3"], fontsize=12)
ax.legend()
plt.tight_layout()
plt.savefig("../plots/por_plot3_studytime_grade.png")
plt.show()
print("Plot 3 saved: ../plots/por_plot3_studytime_grade.png")
...
ax.set_ylabel(LABELS["G3"], fontsize=12)
plt.tight_layout()
plt.savefig("../plots/por_plot4_absences_grade.png")
plt.show()
print("Plot 4 saved: ../plots/por_plot4_absences_grade.png")
...
plt.show()
print("Plot 5 saved: ../plots/por_plot5_correlation_heatmap.png")
...
ax.axhline(y=10, color="#C44E52", linestyle="--", linewidth=1.2,
           label="Pass threshold (10)")
ax.set_title(f"{LABELS['Medu']} vs {LABELS['G3']} — Portuguese",
             fontsize=14, fontweight="bold")
...
ax.legend()
plt.tight_layout()
plt.savefig("../plots/por_plot6_medu_grade.png")
plt.show()
print("Plot 6 saved: ../plots/por_plot6_medu_grade.png")

# ── SUMMARY ───────────────────────────────────────────────────────────────────
corr_matrix_raw = df_raw[numeric_cols].corr()
print()
print("=" * 60)
print("PORTUGUESE PHASE 2 COMPLETE — EDA Summary")
print("=" * 60)
