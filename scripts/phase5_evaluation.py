...
report = pd.DataFrame([
    ...
    },
    {
        ...
        "Precision (Pass)":  round(m_nn["precision"], 4),
        "Recall (Pass)":     round(m_nn["recall"], 4),
        "F1 (Pass)":         round(m_nn["f1"], 4),
        "CV Score (mean)":   round(cv_nn.mean(), 4),
        "CV Score (std)":    round(cv_nn.std(), 4),
...
print()
print("All 5 phases complete. Your thesis pipeline is finished.")